...
import org.example.services.PatientGroupService;
import org.example.services.payloads.requests.GroupByPatientIdRequest;
...
public class PatientGroupController {
    ...
    public Response createNewPatientGroup(PatientGroupRequest request) {
        return Response.ok(new ResponseMessage(StatusTypes.CREATED.label, patientGroupService.createNewPatientGroup(request))).build();
    }
